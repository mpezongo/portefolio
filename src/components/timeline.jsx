...
export const Timeline = ({
  ...
  return (
    (<div
      className="w-full bg-secondary-20 font-sans  tablet:max-w-[1200px]"
      ref={containerRef}>
      <div className="max-w-7xl py-20 mx-auto tel:px-1">
        <h2 className="text-4xl mb-4 text-white dark:text-white max-w-4xl">
          Meet My Experiences
        </h2>
        <p
          className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-sm">
          I&apos;ve been a student for the past 2 years. Here&apos;s
          a timeline of my journey.
        </p>
      </div>
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          <div key={index} className="flex justify-start md:gap-10 mt-10">
            <div
